...
#Build the model
    ...
    c6 = Conv3D(1024, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(p5)
    c6 = InstanceNormalization()(c6)
    # c6 = Dropout(0.3)(c6)
    c6 = Conv3D(1024, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(c6)
    ...
    c7 = Conv3D(512, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(u7)
    c7 = InstanceNormalization()(c7)
    # c6 = Dropout(0.2)(c6)
    c7 = Conv3D(512, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(c7)
    c7 = InstanceNormalization()(c7)
     
    u8 = Conv3DTranspose(256, (2, 2, 2), strides=(2, 2, 2), padding='same')(c7)
    u8 = concatenate([u8, c4])
    c8 = Conv3D(256, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(u8)
    # c8 = Dropout(0.2)(c8)
    c8 = Conv3D(256, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(c8)
     
    u9 = Conv3DTranspose(128, (2, 2, 2), strides=(2, 2, 2), padding='same')(c8)
    u9 = concatenate([u9, c3])
    c9 = Conv3D(128, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(u9)
    # c9 = Dropout(0.1)(c9)
    c9 = Conv3D(128, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(c9)
     
    u10 = Conv3DTranspose(64, (2, 2, 2), strides=(2, 2, 2), padding='same')(c9)
    u10 = concatenate([u10, c2])
    c10 = Conv3D(64, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(u10)
    # c10 = Dropout(0.1)(c10)
    c10 = Conv3D(64, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(c10)

    u11 = Conv3DTranspose(32, (2, 2, 2), strides=(2, 2, 2), padding='same')(c10)
    u11 = concatenate([u11, c1])
    c11 = Conv3D(32, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(u11)
    # c11 = Dropout(0.1)(c11)
    c11 = Conv3D(32, (3, 3, 3), activation='relu', kernel_initializer=kernel_initializer, padding='same')(c11)
